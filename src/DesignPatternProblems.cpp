...
digit_password_validator::digit_password_validator(std::unique_ptr<password_validator> validator)
...
symbol_password_validator::symbol_password_validator(std::unique_ptr<password_validator> validator)
	: password_validator_decorator(std::move(validator))
{
}
